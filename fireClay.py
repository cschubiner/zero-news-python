...
feeds = [("http://feeds.washingtonpost.com/rss/politics", ['politics']),
  ("http://feeds.washingtonpost.com/rss/lifestyle/food", ['lifestyle', 'food']),
  ("http://feeds.washingtonpost.com/rss/entertainment/music", ['entertainment', 'music']),
  ("http://feeds.washingtonpost.com/rss/entertainment/tv", ['entertainment', 'tv']),
  ("http://feeds.washingtonpost.com/rss/entertainment/celebrities", ['entertainment', 'celebrities']),
  ("http://feeds.washingtonpost.com/rss/entertainment/books", ['entertainment', 'books']),
  ("http://feeds.washingtonpost.com/rss/lifestyle/travel", ['lifestyle', 'travel']),
  ("http://feeds.washingtonpost.com/rss/lifestyle/style", ['lifestyle', 'style']),
  ("http://feeds.washingtonpost.com/rss/lifestyle/advice", ['lifestyle', 'advice']),
  ("http://feeds.washingtonpost.com/rss/business", ['business']),
  ("http://feeds.washingtonpost.com/rss/world", ['world']),
  ("http://feeds.washingtonpost.com/rss/sports", ['sports']),
...
for feed_url, topic in feeds:
  ...
  for s in d.entries:
    ...
    try:
      ...
      articles.append({'title':title, 'url':url, 'text':text, 'wordCount':response['word_count'], 'author':response['author'], 'domain':response['domain'], 'date':response['date_published'], 'topics':topics})
    except:
      pass
